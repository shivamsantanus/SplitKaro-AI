...
function LoginForm() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-[#F8FAFC] flex flex-col">
      ...
      {/* Center Section - Logo, Title, Form */}
        ...
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500">
              Log in to continue splitting expenses.
            </p>
          </div>

          {signupSuccess && !error && (
            <div className="bg-emerald-50 border border-emerald-200 text-emerald-600 px-4 py-3 rounded-2xl text-sm font-medium animate-in">
