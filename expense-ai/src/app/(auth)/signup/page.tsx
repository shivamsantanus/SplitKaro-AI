        ...
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500">
              Join SplitSmart AI and start splitting.
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSignup}>
            ...
            <div className="space-y-2">
              <label htmlFor="name" className="text-sm font-semibold text-slate-700 pl-1">
                Full Name
              </label>
              <Input
                id="name"
                placeholder="Enter your full name"
                className="h-14 rounded-2xl bg-white border-slate-200 shadow-sm"
                required
                value={name}
            ...
            {/* Email Input */}
            <div className="space-y-2">
              <label htmlFor="email" className="text-sm font-semibold text-slate-700 pl-1">
                Email address
              </label>
              <Input
                id="email"
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="text-sm font-semibold text-slate-700 pl-1">
                Password
              </label>
              <div className="relative">
                <Input
                  ...
                  className="h-14 rounded-2xl bg-white border-slate-200 shadow-sm pr-12"
                  required
                  value={password}
            ...
            <Button
              type="submit"
              className="w-full h-14 rounded-2xl shadow-md text-base mt-6 font-bold"
              size="lg"
              disabled={loading}
            >
             ...
             <div className="relative py-2">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-[#F8FAFC] px-4 text-slate-400">or sign up with</span>
              </div>
            </div>
